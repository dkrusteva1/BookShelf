...
describe('IceAndFireService', () => {
  ...
  let mockedArray = [
    ...
    },
    {
      ...
      "characters": [
        ...
        "https://anapioficeandfire.com/api/characters/1509",
        "https://anapioficeandfire.com/api/characters/1515",
  ...
  it('should send get request once with the base url', () => {
    service.getBooks().subscribe((res) => {
      expect(res).toEqual(mockedArray);
    }); 
    ...
    req.flush(mockedArray);
  });

  it('should send get request once with the base url and specific book id', () => {
    service.getBookById('1').subscribe((res) => {
      expect(res).toEqual(mockedArray[0]);
    }); 
